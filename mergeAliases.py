#Originally written by Bogden vascilescu
#Modified by konrad wisniewski and Hilmi 
...
dataPath = os.path.abspath('../emails')
...
reader = UnicodeReader(open(os.path.join(dataPath, 'FILTEREDUSERS.csv'), 'rb'))
_header = reader.next()
